...
export default function NotFound() {
  return <main className="blox-lost">
    ...
    <section className="retro-panel blox-lost-panel">
      ...
      <p className="blox-eyebrow">404 · UNCHARTED TERRITORY</p>
      <h1>Off the board.</h1>
      <p>This island doesn’t exist. Your next match is back home.</p>
      <Link className="retro-btn retro-btn-gold" to="/"><ArrowLeft size={18} /> BACK TO ISLAND</Link>
    </section>
  </main>;
}
