...
export default function GameActionMenu({ musicOn, sfxOn, onMusic, onSfx, onSurrender, surrenderDisabled, onNew }: {
  ...
  useLanguage();
  return <DropdownMenu><DropdownMenuTrigger asChild><button className="retro-btn retro-btn-small" aria-label={translateText("Match options")}><MoreHorizontal size={20}/><span>{translateText("More")}</span></button></DropdownMenuTrigger><DropdownMenuContent align="end" className="sky-dropdown">
